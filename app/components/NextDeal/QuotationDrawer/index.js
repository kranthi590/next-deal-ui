  ...
  const getCustomizerContent = () => {
    return <CustomScrollbars className="gx-customizer">
      ...
      <div className="gx-customizer-item">
        <div className="gx-fs-lg gx-text-capitalize gx-mb-2">Suppliers assigned to the quotation</div>
      ...
      <div className="gx-customizer-item">
        <div className="gx-fs-lg gx-text-capitalize gx-mb-2">Responses received to the quotation</div>
        <h2 className="gx-text-primary gx-fs-xlxl gx-font-weight-medium gx-mb-1">09<sub
