        ...
        <Row gutter={16}>
            {
                categories && categories.map(category => {
                    return (<Col xl={8} lg={8} md={8} sm={12} xs={24} key={category.id}>
                        <a onClick={() => { if (onClick) { onClick(category.id) } }}>
                                ...
                                <div className="ant-card-body">
                                    <div className="gx-media gx-align-items-center gx-flex-nowrap">
                                        <div className="gx-media-body gx-text-center">
                                            ...
                                            <div className="gx-text-grey gx-text-truncate gx-mb-0">{category.name}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
