                ...
                <div className="gx-d-flex">
                    <div style={{ width: "60%" }}>
                        <div className="gx-d-flex gx-justify-content-around gx-align-items-end gx-mx-auto">
                            ...
                            <Skeleton.Input style={{ height: 80, width: 20 }} active className="gx-d-none gx-d-sm-block" />
                            <Skeleton.Input style={{ height: 120, width: 20 }} active />
                            <Skeleton.Input style={{ height: 210, width: 20 }} active className="gx-d-none gx-d-md-block" />
