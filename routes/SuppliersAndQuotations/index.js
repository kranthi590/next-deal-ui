            ...
            <Card className="ant-card gx-card-widget">
                ...
                </div>
                {
                    buyerId ?
                        <div>
                            <iframe
                                src={`https://metrics.nextdeal.dev/d-solo/lQAafVo7k/suppliers-and-quotations?orgId=1&var-Buyer=${buyerId}&var-Project=All&from=1642077601483&to=1642682401483&panelId=10`}
                                width="100%"
                                height="300"
                                frameBorder="0"
                            />
                            <div>
                                <iframe
                                    src={`https://metrics.nextdeal.dev/d-solo/lQAafVo7k/suppliers-and-quotations?orgId=1&var-Buyer=${buyerId}&var-Project=All&from=1642077669000&to=1642682469000&panelId=8`}
                                    width="100%"
                                    height="300"
                                    frameBorder="0"
                                />
...
const SuppliersAndQuotations = (props) => (<ProjectProvider>
